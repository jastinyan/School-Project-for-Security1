    ...
    <div class="login-box container">
        ...
        <form id="loginForm" action="login.php" method="POST" class="form">
            ...
            <div class="input-field">
                ...
                <input class="input" type="text" id="username" name="username" required placeholder="Enter your username">
            </div>
            ...
            <div class="forgot-password" style="display: none;" id="forgotPasswordContainer">
            </div>

            <div id="timerDisplay" style="display: none; margin-top: 10px; color: red;">
                Access Denied. Try again in: <span id="lockoutTimeDisplay">0</span> seconds
            </div>
        </form>
    </div>
